...
%       and clarity in writing, references).
%   C+ to D-:
%       Well organised and written but some issues in language, the flow of 
%       the document, references, etc.
%   E+ to G:
%        Badly prepared document (poor organisation, poor layout, sloppy 
%       English, and lack of clarity in writing).
%
% Feedback from Interim Report: B+
%   + Writing was generally clear and well presented with a clear layout and 
%     structure. 
%   + The text was at times disjointed, however - for example, things 
%     discussed before being introduced and figures not referred to in text. 
%   + The diagrams were of high quality. Good use of concrete examples and 
%     figures.
%
%
...
%                                  INTRODUCTION
%==============================================================================
% This chapter was not technically requested but I (jónsi) we should include it 
...
%
% Feedback from Interim Report: B+
%   The problem is fairly well-defined, as are the target users (although this 
%   could have been clearer - would be helpful to have some justification or 
%   citation for definition of "power user"). However, the discussion of why 
%   this is an important problem to solve is a little weak. Good concrete use 
%   cases, examples are helpful. A little confusion over whether these use 
%   cases involve recommendation, or rather just filtering/ranking.
%
...
%     problem? (how do they meet or fail to meet the needs of your target users)
%
% Grading:
%   A+ to B-:
...
%       hard”), technical problems do not relate to the user scenario 
%       described or coverage of existing systems is limited.
%   E+ to G:
%       Inability to identify the technical challenges in addressing the user 
%       problem described in the previous section
%
% Feedback from Interim Report: B-
%   The core technical problem of how to make good recommendations is 
%   ignored, and instead this section focused on issues with rate limits in 
%   the Twitter API. While this is interesting (and demonstrates a  clear 
%   understanding of the operation and limitations of the Twitter REST API), 
%   it is not the core issue at the heart of the project. Reasonable coverage 
%   of existing apps such as Flipboard.
...
%   + Data: What data resources are you using and how do you access, collect, 
%     and store them? What bottlenecks do you face related to data, what 
%     choices have you made to address them?
%   + What are the key technical contributions of your solution?
%
% Grading:
%   A+ to B-:
%	    Clear description of overall system architecture with all key 
%       components identified. Good descriptions of key front-end and back-end 
%       technologies, and justification of these choices. Clear identification 
%       of key data sources and description of how they are accessed, collected 
%       and stored. Clear presentation of the key technical contributions of 
%       the project.
%   C+ to D-:
%       Reasonable description of system architecture but missing detail in 
%       some key areas – e.g. missing data sources, no justification of likely 
%       front-end or back-end technologies etc.
%   E+ to G:
%       Very limited description of the overall system architecture missing 
%       some key components.
%
% Feedback from Interim Report: B-
%   There is good detail on the overall architecture of the system, the 
%   technologies used, and why these technologies were selected. Good 
%   description of front-end components and communications with back-end. 
%   There is, however, not enough information about the recommender part of 
%   the project. A "bag-of-words approach" doesn't mean anything. More detail 
%   on how this works was needed. Ideally database solution would be 
%   identified at this stage. The choice of JSON store will have implications 
%   for the filtering/recommendation process. For tweet filtering, are only 
%   raw term frequencies used, or are these values weighted (e.g. using 
%   inverse document frequency relative to a larger set of tweets). Also, will 
%   recency be taken into account for filtering? How are filtered and 
%   recommended tweets merged into the same timeline?
...
%                                  EVALUATION
%==============================================================================
% Weight: 20%, 2000 words
%
%   + What components of your system are you evaluating and why?
%	+ How are you evaluating them (data, users, evaluation metrics)?
%	+ What have you learned from the evaluation?
%
% Grading:
%   A+ to B-:
%	    Well thought out, realistic evaluation, including evaluation of 
%       different aspects of the system as well as the system as a whole. 
%       Thorough discussion of the outcome of the evaluation.
%   C+ to D-:
%       Somewhat clear evaluation, but some aspects not convincing.
%   E+ to G:
%       No evaluation done or very poorly thought and executed evaluation.
%
% Feedback from Interim Report: B+
%   + The key question is not entirely clear, what does "interesting" mean
%     in this context? Try to provide some definition or example when giving
%     instructions to participants.
%   + Good justification of related approaches, although not entirely
%     clear what are the useful ideas for developing the user evaluation and
%     how does the related work do the evaluation, e.g, setup, data,
%     metrics.
%   + The evaluation setup and data collected is reasonably clear.
%   + The evaluation interface itself is well designed. Makes sense to
%     that participants use team member phones, so no need for the
%     participants to install the software.
%   + 15 minutes is probably a high estimate for time required to read 20
%     tweets. Indicating that the task takes 10 minutes might make it easier
%     to attract participants.
%   + The setup, users and metrics are clear. Could be useful to test 2
%     different versions of the recommender, time permitting. Could be
%     useful to have an option for users to provide qualitative or other
%     feedback for the app.
%   + While counting the total number of likes/dislikes across all users
%     is one way of summarising the results, the results could summarised on
%     a user basis (i.e. how many users liked more tweets from Lambda
%     Lovelace’s feed, as opposed to the Twitter feed)."
%   + Overall the report is well written, but there is unnecessarily often
%     repetition of "team lambda Lovelace" - you can use we, or us or our.
...
%                                  CONCLUSION
%==============================================================================
% Weight: 10%, 1000 words
%
%   + What was your project management strategy?
%	+ What were the biggest challenges you faced as a team during the project 
%     and how did you address them?
%	+ What is the key contribution of your project and what future extensions 
%     do you envision for improving your system?
%
% Grading:
%   A+ to B-:
%	    Clear reflections on team work process, learning process and updating
%       future strategy to improve project execution. Thorough discussion on 
%       strengths and weaknesses of proposed solution and important future 
%       extensions.
%   C+ to D-:
%       Some reflections, but not very deep.
%   E+ to G:
%       Not much reflection on team work and project management process.
%
% Feedback from Interim Report: B+
%   + Decent description of project management methodology. 
%   + The list of core issues is good, as is the discussion of them. 
%   + Reasonable plan for the remainder of the project. However, the plan 
%     appears to underestimate the time it might take to ensure that both 
%     filtering and recommendation are working correctly, and how the outputs 
%     of the process might be integrated into a single timeline.
